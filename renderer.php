...
class local_tutores_renderer extends plugin_renderer_base {
    ...
    public function create_confirmation($return_url, $confirm_url, $curso_ufsc) {
        global $OUTPUT;
        ...
        $output .= $OUTPUT->confirm(get_string('confirm_relationship_creation', 'local_tutores', $curso_ufsc), $formcontinue, $formcancel);
