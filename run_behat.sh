#!/bin/bash
# =============================================================================
# run_behat.sh - Executa testes Behat do plugin local_tutores via Docker
#
# Uso:
#   ./run_behat.sh                                  # Roda todos os testes @local_tutores
#   ./run_behat.sh tests/behat/algum.feature        # Roda um feature file específico
#   ./run_behat.sh --tags=@alguma_tag               # Filtra por tag
#   ./run_behat.sh --name="nome do cenário"         # Filtra por nome do cenário
...
PLUGIN_COMPONENT="local_tutores"
PLUGIN_RELPATH="local/tutores"
PLUGIN_TAG="@local_tutores"
...
if [ -n "$FEATURE_FILE" ]; then
    if [[ "$FEATURE_FILE" == /* ]]; then
        ...
        FEATURE_PATH="$MOODLE_ROOT_IN_CONTAINER/$PLUGIN_RELPATH/$FEATURE_FILE"
    fi
