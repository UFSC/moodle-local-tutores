...
if (empty($curso_ufsc)) {
    throw new moodle_exception('curso_ufsc_nao_encontrado_error', 'local_tutores');
}
...
// moodle_exception se não houver (ou houver mais de um) relationship — então aqui sempre há um.
