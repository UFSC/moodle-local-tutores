#!/bin/bash
# =============================================================================
# run_tests.sh - Executa testes PHPUnit do plugin local_tutores via Docker
#
# Uso:
...
# Exemplos:
#   ./run_tests.sh
#   ./run_tests.sh tests/tutores_smoke_test.php
#   ./run_tests.sh --reset
# =============================================================================
...
PLUGIN_TEST_DIR="$MOODLE_ROOT_IN_CONTAINER/$PLUGIN_RELPATH/tests"
...
if [ -n "$TEST_FILE" ]; then
    ...
    if [[ "$TEST_FILE" == /* ]]; then
        ...
        TEST_PATH="$MOODLE_ROOT_IN_CONTAINER/$PLUGIN_RELPATH/$TEST_FILE"
    fi
