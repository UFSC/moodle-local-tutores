...
$string['confirm_relationship_creation'] = 'Você deseja configurar um grupo de tutoria para o curso "{$a}"?';
$string['curso'] = 'Curso';
$string['cursos_ufsc'] = 'Cursos UFSC';
$string['definir_permissoes'] = 'Definir permissões';
$string['definir_permissoes_curso'] = 'Participantes do grupo "{$a}"';
...
$string['description_orientadores_allowed_roles'] = 'Papéis que representam orientadores';
...
$string['settings_orientadores_allowed_roles'] = 'Orientadores';
